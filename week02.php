...
<html>
    ...
    <body onload="deleteCookies();">
        ...
        <div class="gallery">
            ...
            <input type="checkbox" name="list[]" id="002" value="Tan Plain Backpack"><label>Tan Plain Backpack</label>
        </div>
        <div class="gallery">
            ...
            <input type="checkbox" name="list[]" id="003" value="Rainbow Backpack"><label>Rainbow Backpack</label>
        </div>
        <div class="gallery">
            ...
            <input type="checkbox" name="list[]" id="004" value="Black Adidas Backpack"><label>Black Adidas Backpack</label>
        </div>
        <div class="gallery">
            ...
            <input type="checkbox" name="list[]" id="005" value="Plain Grey Backpack"><label>Plain Grey Backpack</label>
        </div>
        <div class="gallery">
        ...
        <div class="gallery">
            ...
            <input type="checkbox" name="list[]" id="007" value="Pattern Backpack"><label>Pattern Backpack</label>
        </div>
        <div class="gallery">
            ...
            <input type="checkbox" name="list[]" id="008" value="Giraffe Backpack"><label>Giraffe Backpack</label>
        </div>
